...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> ok(T datos) {
        return ApiResponse.<T>builder().exitoso(true).mensaje("Operación exitosa").datos(datos).build();
    }
    ...
    public static <T> ApiResponse<T> created(T datos) {
        return ApiResponse.<T>builder().exitoso(true).mensaje("Recurso creado exitosamente").datos(datos).build();
    }
